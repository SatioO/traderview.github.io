          ...
          <div className="lg:col-span-1">
            <div className="bg-black/40 backdrop-blur-xl rounded-3xl p-6 shadow-2xl border border-cyan-500/30 sticky top-8 hover:border-cyan-400/50 transition-all duration-500 hover:shadow-cyan-500/20 hover:shadow-2xl">
              ...
              {showMarketOutlookPanel && (
                ...
                >
                  <div className="bg-gradient-to-br from-slate-900/98 via-purple-900/95 to-slate-800/98 backdrop-blur-3xl rounded-2xl border-2 border-purple-400/60 shadow-2xl p-6 relative overflow-hidden">
                    {/* Gaming Particle Background */}
                    <div className="absolute inset-0 overflow-hidden">
                      <div className="absolute top-0 left-0 w-2 h-2 bg-purple-400/30 rounded-full animate-pulse"></div>
                      <div
                        className="absolute top-4 right-4 w-1 h-1 bg-cyan-400/40 rounded-full animate-pulse"
                        style={{ animationDelay: '1s' }}
                      ></div>
                      <div
                        className="absolute bottom-6 left-8 w-1.5 h-1.5 bg-green-400/20 rounded-full animate-pulse"
                        style={{ animationDelay: '2s' }}
                      ></div>
                    </div>

                    {/* Header */}
                    <div className="flex items-center justify-between mb-6 border-b border-purple-400/20 pb-4 relative z-10">
                        ...
                        <button
                          ...
                          className={`group relative p-3 text-sm font-bold rounded-xl border-2 transition-all duration-300 hover:scale-105 overflow-hidden ${
                            formData.marketHealth === trend.key
                              ? `${trend.borderColor} ${trend.bgActive} shadow-lg ${trend.shadowActive} ${trend.textActive} transform scale-105`
