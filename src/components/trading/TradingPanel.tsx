            ...
            <div className="mt-3 p-3 bg-gradient-to-r from-amber-900/20 to-orange-900/20 border border-amber-400/20 rounded-lg">
              ...
              {accountBalance && (
                <div className="mt-2 text-xs text-amber-200">
                  {((riskAmount / accountBalance) * 100).toFixed(1)}% of
                  portfolio at risk
                </div>
              )}
            </div>
          ...
          <div className="p-3 bg-slate-800/30 border border-slate-600/20 rounded-lg">
            <div className="flex items-start space-x-2">
              ...
              <div className="text-xs text-slate-400 leading-relaxed">
                <strong className="text-slate-300">Risk Disclaimer:</strong>{' '}
                Trading in securities involves risk of loss. Past performance is
                not indicative of future results. Please ensure you understand
                the risks before placing trades. Only invest what you can afford
                to lose.
              </div>
            </div>
          </div>
